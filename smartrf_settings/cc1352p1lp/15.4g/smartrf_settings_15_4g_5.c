...
// Overrides for CMD_PROP_RADIO_DIV_SETUP_PA
uint32_t Ieee154g5_pOverridesTxStd[] =
{
...
// Overrides for CMD_PROP_RADIO_DIV_SETUP_PA
uint32_t Ieee154g5_pOverridesTx20[] =
{
    // The TX Power element should always be the first in the list
...
rfc_CMD_PROP_RADIO_DIV_SETUP_PA_t Ieee154g5_cmdPropRadioDivSetup =
{
    .commandNo = 0x3807,
    .status = 0x0000,
    ...
    .txPower = 0xFFFF,
    .pRegOverride = Ieee154g5_pOverrides,
    .centerFreq = 0x0393,
    .intFreq = 0x8000,
    .loDivider = 0x05,
    .pRegOverrideTxStd = Ieee154g5_pOverridesTxStd,
    .pRegOverrideTx20 = Ieee154g5_pOverridesTx20
};


// CMD_FS
// Frequency Synthesizer Programming Command
rfc_CMD_FS_t Ieee154g5_cmdFs =
{
    .commandNo = 0x0803,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
...
rfc_CMD_PROP_RX_ADV_t Ieee154g5_cmdPropRxAdv =
{
    .commandNo = 0x3804,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
...
rfc_CMD_PROP_TX_ADV_t Ieee154g5_cmdPropTxAdv =
{
    .commandNo = 0x3803,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
