...
#include "smartrf_settings_15_4g_11.h"


// TI-RTOS RF Mode Object
RF_Mode Ieee154g11_mode =
{
    .rfMode = RF_MODE_AUTO,
...
uint32_t Ieee154g11_pOverrides[] =
{
...
// Overrides for CMD_PROP_RADIO_DIV_SETUP_PA
uint32_t Ieee154g11_pOverridesTxStd[] =
{
...
// Overrides for CMD_PROP_RADIO_DIV_SETUP_PA
uint32_t Ieee154g11_pOverridesTx20[] =
{
    // The TX Power element should always be the first in the list
...
rfc_CMD_PROP_RADIO_DIV_SETUP_PA_t Ieee154g11_cmdPropRadioDivSetup =
{
    .commandNo = 0x3807,
    .status = 0x0000,
    ...
    .txPower = 0x013F,
    .pRegOverride = Ieee154g11_pOverrides,
    .centerFreq = 0x0364,
    .intFreq = 0x0599,
    .loDivider = 0x05,
    .pRegOverrideTxStd = 0,
...
rfc_CMD_PROP_RX_ADV_t Ieee154g11_cmdPropRxAdv =
{
    .commandNo = 0x3804,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
...
rfc_CMD_PROP_TX_ADV_t Ieee154g11_cmdPropTxAdv =
{
    .commandNo = 0x3803,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
